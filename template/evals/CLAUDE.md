...
```bash
AGENT_URL=http://my-agent:10999 MCP_URL=http://my-mcp:8001 python run_evals.py --suite all
```
...
### 1. Behavior (`@behavior/test_behavior.py`)
...
### 2. Compliance (`@compliance/test_compliance.py`)
...
### 3. Latency (`@latency/bench_latency.py`)
...
**Running**:
```bash
BENCH_N=20 python @latency/bench_latency.py
```
...
### 4. Quality (`@quality/judge_quality.py`)
...
4. Run `python run_evals.py --suite behavior` to verify
