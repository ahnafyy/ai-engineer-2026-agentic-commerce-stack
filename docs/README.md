...
| [evals.md](evals.md) | The four eval suites, how to run them locally and in Docker, how to read the output, and the GitHub Models rate-limit caveat |
...
demo/
  ...
  merchant-agent/  GPT-4o agent — A2A + UCP + AP2 + /ws/trace WebSocket        (:10999)
